...
var Cookie = /** @class */ (function () {
    ...
    Cookie.prototype.set = function (key, object, parameters) {
        ...
        var useSecure = window.location.protocol === "https" ? ";secure" : ";";
        document.cookie = encodeURIComponent(key) + "=" + decodeURIComponent(JSON.stringify(object)) + ";path=" + path + ";expires=" + utils_1.fnDate(expires) + ";samesite=strict" + useSecure;
        return this;
    };
    return Cookie;
}());
